...
const List = () => {
  ...
  return (
    <div className='bg-black text-[#eeeeee]'>
      ...
      <div className='w-[700px] h-full mx-auto mt-10 rounded-[5px] border-[#A0A1A4] border-[2px]'>
        <div className='flex justify-between p-5 border-b-2 border-b-[#A0A1A4]'>
          ...
          <div className='flex justify-between w-[55%]'>
            <button
              ...
              className='w-[20%] px-3 py-0.5 border-2 border-[#A0A1A4] rounded-[6px] hover:bg-[#585555]'>
              All
            </button>
            <button
            ...
            <button
              ...
              className='w-[25%] px-3 py-1 bg-[#c72543] rounded-[5px] hover:bg-[#881414]'>
              Delete all
            </button>
          </div>
        </div>
